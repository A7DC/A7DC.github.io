  ...
  <ContentContainer>
    <section ref={r => this.container = r}>
      <div className='ph2 ph5-ns w-100 h-100 mw7 mla mra relative'>
        ...
        <p className={typography.pLead}>Whether it be conducting usability testing, designing in Sketch, or building real-world apps in React, my varied skillset means I’m able to fit easily into any agile team, large or small.</p>
      </div>
    </section>
  </ContentContainer>
)
