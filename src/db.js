  ...
  caseStudy: [
    {
      bordellio: {
        features: [
          ...
          { title: 'Messaging', content: 'Messaging between advertiser and client is completely encrypted using the Signal API. It is here the two parties are able to discuss the details of their date, as well as send / request identification and / or deposits.', video: '/images/case-study/bordellio/3.png' },
          ...
          { title: 'Confirming date', content: 'After the advertiser has accepted the message request, they will then have to confirm the date request itself. Once done, the client will be able to confirm the date!', video: '/images/case-study/bordellio/6.png' },
          { title: 'Declining a date', content: 'After the advertiser has accepted the message request, both parties will have the option to decline the date request. Once done, the conversation will instantly self-destruct.Neither party will be rated.', video: '/images/case-study/bordellio/7.png' },
